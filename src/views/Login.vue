...
<template>
    <div id="login-wrapper">
        <div id="login">
            ...
            <div class="login-con">
                <transition appear name="fade">
                    <Card icon="log-in" title="登录">
                        <div class="form-con">
                            <div class="content">
                                <img src="../assets/imgs/a.gif">
                                <Form ref="form" :model="form" :rules="rules">
                                    <FormItem prop="username">
                                        <Input prefix="ios-contact" v-model="form.username" placeholder="用户名"
                                               clearable />
                                    </FormItem>
                            ...
                            <div class="button">
                                <Button :loading="isShowLoading" class="submit" type="primary" @click="verify('form')">
                                    登录
                                </Button>
                            </div>
                        </div>
