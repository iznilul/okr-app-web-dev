...
<!--        <template slot-scope="scope">-->
<!--          <el-button @click="handleEdit(scope.row)" type="primary" size="small" v-permission="'/blog/edit'"-->
<!--            >编辑</el-button-->
<!--          >-->
<!--          <el-button @click="handleDelete(scope.row)" type="danger" size="small" v-permission="'/blog/delete'"-->
<!--            >删除</el-button-->
<!--          >-->
<!--        </template>-->
<!--      </el-table-column>-->
...
<!--        blogSortUid: [{ required: true, message: '分类不能为空', trigger: 'blur' }],-->
<!--        level: [-->
