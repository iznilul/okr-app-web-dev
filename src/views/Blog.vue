<template>
    <div id="blog">
        <Card id="content">
            ...
            <!--&lt;!&ndash;                        <span>{{ dayjs(topic.createTime).format('YYYY/MM/DD HH:mm:ss') }}</span>&ndash;&gt;-->
            <!--&lt;!&ndash;                        <el-divider direction="vertical" />&ndash;&gt;-->
            <!--&lt;!&ndash;                        <span>发布者：{{ topicUser.alias }}</span>&ndash;&gt;-->
            <!--&lt;!&ndash;                        <el-divider direction="vertical" />&ndash;&gt;-->
            <!--&lt;!&ndash;                        <span>查看：{{ topic.view }}</span>&ndash;&gt;-->
            <!--                        <span>1</span>-->
            <!--&lt;!&ndash;                        <el-divider direction="vertical" />&ndash;&gt;-->
            <!--                        <span>发布者：</span>-->
            <!--&lt;!&ndash;                        <el-divider direction="vertical" />&ndash;&gt;-->
            ...
            <!--                        <p class="level-item">-->
            <!--                            <Tag v-for="item in tagList" :key="item" :name="item" closable @on-close="handleClose">{{ item }}</Tag>-->
            <!--                        </p>-->
            <!--                    </div>-->
            <!--                </nav>-->
